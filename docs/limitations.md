...
evidence, but ENA, physical-PMD, and performance conclusions remain unsupported.
RDMA has no execution evidence and must not be presented as validated behavior.
